...
# Usage:
#   dataset = SUNRGBD(transform=..., data_dir="/path/to/SUNRGBD", txt_name="train.txt")
# Expected structure:
#   data_dir/
#     train_image, train_depth, train_label
#     test_image, test_depth, test_label
#     train.txt / test.txt listing file basenames (without extensions)
...
class SUNRGBD(Dataset):
    def __init__(self, transform=None, phase_train=True, data_dir=None, txt_name='train.txt'):
        ...
        """Build image/depth/label folder paths."""
        ...
        """Read filenames for images/depths/labels (different extensions)."""
